...
public class BothModelsLocalization {
	...
	public BothModelsLocalization(SimulatedRobot _robot, LineMap _lineMap,
	...
	public void run() {
		...
		SensorModel sensorModel = new NonPerfectSensor();
		...
		while (true) {
			...
			// movementens for action + sensor model
			
			
				movementHeading = Heading.PLUS_X;
				while (lineMap.range(m_robot.getPose()) > m_translationAmount) {
	...
	public static void main(String[] args) {
		...
		BothModelsLocalization ml = new BothModelsLocalization(robot,
